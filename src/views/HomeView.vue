          ...
          <v-row justify="center" class="space">
            <v-col cols="12" md="2">
              <v-item v-slot="{ active, toggle }">
                <v-card :color="active ? '#49D9A0' : 'white'" class="d-flex align-center rounded-xl" dark height="200"
                  @click="toggle">
                  <v-row>
                    <v-col cols="12" sm="12">
                      <v-list-item three-line class="mt-10">
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle :class="active ? 'white--text' : 'black--text'">Team
                    ...
                    <v-col cols="12" sm="12">
                      <v-list-item three-line class="mt-10">
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle :class="active ? 'white--text' : 'black--text'">Tasks
                    ...
                    <v-col cols="12" sm="12">
                      <v-list-item three-line class="mt-10">
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle :class="active ? 'white--text' : 'black--text'">Spikes
                            delivered</v-list-item-subtitle>
                          <v-list-item-title class="headline mb-1" :class="active ? 'white--text' : 'black--text'">
                            <strong>23</strong>
                          </v-list-item-title>
                    ...
                    <v-col cols="12" sm="12">
                      <v-list-item three-line class="mt-10">
                        <v-list-item-content>
                          ...
                          <v-list-item-subtitle :class="active ? 'white--text' : 'black--text'">News
          ...
          <v-col cols="12" sm="3">
            <v-list subheader two-line>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Omar</v-list-item-title>

                  <v-list-item-subtitle>42 Story point</v-list-item-subtitle>
                </v-list-item-content>
          ...
          <v-col cols="12" sm="3">
            <v-list subheader two-line>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Mostafa</v-list-item-title>
          ...
          <v-col cols="12" sm="3">
            <v-list subheader two-line>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Fatma</v-list-item-title>
          ...
          <v-col cols="12" sm="3">
            <v-list subheader two-line>
              <v-list-item>
                ...
                <v-list-item-content>
                  <v-list-item-title>Salma</v-list-item-title>
